...
class Items(Base):
    ...
    picture = Column(String(250))
    # Relate the items table with the category table by storing
    # category.category.id as items.category_id
    category_id = Column(Integer, ForeignKey('category.id'))
    # If a category (type) is deleated, all the items (Pokemon) related to
    # this category also are deleted
